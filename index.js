...
import referentielijstHandler from './api/referentielijst.js';
...
app.get('/api/referentielijst',  referentielijstHandler);
app.post('/api/referentielijst', referentielijstHandler);
app.put('/api/referentielijst',  referentielijstHandler);
